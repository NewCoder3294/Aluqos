  ...
  return (
    <div className="rounded-md border border-paper-edge bg-white p-4">
      ...
      <div className="space-y-1.5">
        <div className="h-2 rounded-full bg-paper-hi" style={{ width: "94%" }} />
        <div className="h-2 rounded-full bg-paper-hi" style={{ width: "82%" }} />
        <div className="h-2 rounded-full bg-paper-hi" style={{ width: "100%" }} />
        <div className="h-2 rounded-full bg-paper-hi" style={{ width: "68%" }} />
        <div className="h-2 rounded-full bg-coral/30 relative" style={{ width: "55%" }}>
          <span
      ...
      <div className="mt-3 text-[11px] text-ink-muted serif italic leading-snug">
            ...
            >
              <Card className="flex flex-col w-full">
                <CardContent className="flex flex-col gap-4">
                  <div className="serif text-[36px] leading-none text-coral-deep tracking-[-0.02em]">
                    {s.n}
                  </div>
                  <div>
