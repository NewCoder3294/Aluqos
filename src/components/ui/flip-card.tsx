...
// Hover-driven 3D flip card. Composed as <FlipCard><FlipCardFront/><FlipCardBack/></FlipCard>.
// Adapted from the 21st.dev FlipCard primitive — uses motion/react which is
// already a dependency. The container is the perspective parent; front and
// back rotate in opposite directions so only one face is visible at a time.
...
const FlipCard = React.memo(
  React.forwardRef<HTMLDivElement, FlipCardProps>(
    (
      ...
      // Keyboard support: space/enter toggles flip for accessibility.
